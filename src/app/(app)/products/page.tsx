    ...
    <div className="space-y-8">
      ...
      <Card>
        ...
        <CardContent className="space-y-3">
            ...
            <li><strong>تتبع الكميات المباعة:</strong> يتم عرض الكمية المباعة لكل منتج. (ملاحظة: يتم تحديث هذا الرقم يدويًا عند تعديل المنتج أو من خلال عمليات بيع مستقبلية).</li>
            ...
            <li><strong>حساب الأرباح على مستوى الوحدة والقطعة:</strong> إذا كان للمنتج عدد قطع محدد بالوحدة (مثل علب داخل كرتون)، يمكن للذكاء الاصطناعي حساب وعرض الربح لكل قطعة فرعية عند سؤاله. ويمكنه أيضًا حساب الربح بناءً على سيناريوهات أسعار تقدمها أنت.</li>
            </ul>
            ...
            <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4 rtl:mr-4 rtl:ml-0">
                ...
                <li><strong>ملخص المبيعات والمشتريات (مستقبلي):</strong> عرض ملخص للمبيعات والمشتريات لفترات (شهرية/سنوية) يتطلب نظامًا لتسجيل كل معاملة بيع وشراء بشكل مفصل، وهو ما يمكن إضافته في تحديثات قادمة.</li>
                <li><strong>دردشة مساعدة للمدير (متاحة الآن!):</strong> اطرح أسئلة باللغة العربية حول منتجاتك (مثل: "ما هي المنتجات الأكثر ربحية؟"، "كم أربح من الحليب إذا كان سعر شراء الكرتون X وأبيع العلبة Y والكرتون فيه Z علبة؟"، "هل مخزون الطماطم منخفض؟") واحصل على إجابات فورية من المساعد الذكي أدناه.</li>
            </ul>
        </CardContent>
      </Card>

    ...
    <div className="space-y-8">
      ...
      <Card>
        ...
        <CardContent className="space-y-3">
            ...
            <li><strong>إضافة وتعديل الأصناف:</strong> أدخل اسم الصنف، الفئة، وحدة القياس، سعر البيع، سعر الشراء، الكمية المتوفرة، حد المخزون المنخفض، عدد القطع بالوحدة، وتاريخ الانتهاء.</li>
            <li><strong>عرض قائمة الأصناف المفصلة:</strong> يتم عرض جميع الأصناف مع تفاصيلها الكاملة، بما في ذلك حالة المخزون (متوفر، منخفض، نفد) وحالة الصلاحية (صالح، قارب على الانتهاء، منتهي).</li>
            ...
            <li><strong>تتبع الكميات المباعة:</strong> (ملاحظة: يتطلب نظام تسجيل مبيعات لتحديث هذا الرقم تلقائيًا، حاليًا يتم تهيئته بـ 0).</li>
            ...
            <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4 rtl:mr-4 rtl:ml-0">
                <li><strong>تحليل الأرباح والخسائر (المحتملة):</strong> يقوم الذكاء الاصطناعي بتحليل أسعار البيع والشراء للمخزون الحالي لتقدير الربحية.</li>
                ...
                <li><strong>دردشة مساعدة للمدير (متاحة الآن!):</strong> اطرح أسئلة باللغة العربية حول منتجاتك واحصل على إجابات فورية من المساعد الذكي أدناه.</li>
            </ul>
        </CardContent>
      </Card>

...
export default function DashboardPage() {
  ...
  const fetchAiSummary = async () => {
    if (stats.numberOfDebtors === 0) {
      setAiSummary({
        summary: "No debtor data available to generate a summary.",
        riskAssessment: "N/A",
        recommendations: "Add debtor information to get an AI-powered summary and recommendations."
      });
      return;
    }
    ...
    try {
      ...
      setAiSummary({
        ...
        riskAssessment: "Could not assess risk.",
        ...
        <CardHeader className="flex flex-row items-center justify-between">
          <div>
            <CardTitle className="text-xl font-headline flex items-center">
              <Sparkles className="h-6 w-6 me-2 text-primary" />
              AI Debt Overview
            </CardTitle>

...
export default function SignupPage() {
  ...
  const confirmPasswordLabel = t("confirmPasswordLabel");
  const signupButtonText = t("signupButton");
  const loadingSignupButtonText = t("loadingSignupButton");
  const loginPromptText = t("loginPrompt");
  const loginLinkText = t("loginLink");
  const toastSignupSuccessTitle = tToast("signupSuccessTitle");
  const toastSignupSuccessDescription = tToast("signupSuccessDescription");
  const toastSignupFailedTitle = tToast("signupFailedTitle");
    ...
    try {
      ...
      let errorMessage = err.message;
       if (err.code === "auth/email-already-in-use") {
        errorMessage = "This email address is already in use."; // Translate
      } else if (err.code === "auth/weak-password") {
        errorMessage = "The password is too weak. Please use a stronger password."; // Translate
      } else if (err.code === "auth/invalid-email") {
        errorMessage = "The email address is not valid."; // Translate
      }
